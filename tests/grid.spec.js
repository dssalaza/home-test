...
test.describe('Grid ', () => {
   ...
   test.only('8. Grid All Items Test', async () => {
      ...
      await expect (gridPage.getAddOrderBtnByIndex(0)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(1)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(2)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(3)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(4)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(7)).toBeVisible();
      ...
      await expect (gridPage.getAddOrderBtnByIndex(8)).toBeVisible();
   });
});